package com.android.splus.sdk._duoku;
...
public class _DuoKu implements IPayManager{
    ...
    @Override
    public void login(Activity activity, com.android.splus.sdk.apiinterface.LoginCallBack loginCallBack) {
